...
ENTRIES: dict[str, HelpEntry] = {
    ...
    "changes": HelpEntry(
        "changes",
        "Cambios integrables",
        "Agrupa aplicaciones, archivos y pasos por la transformación que consiguen. Puedes marcar varias y revisarlas como un lote secuencial.",
        "PhotoGIMP, Affinity y un .stylerpkg pueden seleccionarse juntos; cada DAG conserva sus recibos y el lote se detiene si uno falla.",
        "changes",
    ),
