"""Selección estructural de nodos antes de enviar el plan a PipeCraft."""

from __future__ import annotations

from dataclasses import dataclass

from styler.planning.graph import ancestors_of, dependency_closure, descendants_of, matching_node_ids, topological_order
from styler.planning.models import ExecutionContext, ExecutionPlan
