"""Contrato canónico de planificación semántica de Styler.

El modelo conserva la semántica de planificación introducida durante la
evolución de PipeCraft, pero no implementa su runtime. Un workflow de Styler se
compila a un plan estable; PipeCraft 1.5 recibe ese plan y posee la ejecución.
"""
...
class StepDefinition:
    ...
    # Composición y explicabilidad del plan semántico.
    phase: str = ""
    block: str = ""
    tags: list[str] = field(default_factory=list)
    run_if: str = RunCondition.ALL_SUCCESS
...
class ExecutionContext:
    ...
    # Selección estructural de nodos.
